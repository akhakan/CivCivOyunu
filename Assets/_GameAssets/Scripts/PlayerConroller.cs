...
public class PlayerScript : MonoBehaviour
{
    ...
    [SerializeField] private Transform _orientationTransform; // Oryantasyon game objectini koda baðlama -> Sürükle Býrak
    ...
    private void Update()
    {
       ...
       _movementDirection = _orientationTransform.forward * _verticalInput + _orientationTransform.right * _horizontalInput;        //(-1,0,0)        //(X,Y,Z)    
